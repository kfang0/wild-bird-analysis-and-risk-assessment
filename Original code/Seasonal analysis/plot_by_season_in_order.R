...
# 执行 Kruskal-Wallis检验，并使用 Bonferroni 校正
...
# ggplot(df_summary_total, aes(x = season, y = record_count, fill = season)) +
#   geom_boxplot() +
#   geom_jitter(width = 0.15, size = 2, alpha = 0.7) + 
#   stat_compare_means(comparisons = comparisons, adjust.method = "bonferroni",
#                      method = "wilcox.test") +
#   scale_fill_aaas() +
...
# p2 <- ggplot(df_summary_Anseriformes, aes(x = season, y = record_count, fill = season)) +
#   geom_boxplot() +
#   geom_jitter(width = 0.15, size = 2, alpha = 0.7) + 
...
# p3 <- ggplot(df_summary_Accipitriformes, aes(x = season, y = record_count, fill = season)) +
#   geom_boxplot() +
#   geom_jitter(width = 0.15, size = 2, alpha = 0.7) + 
#   stat_compare_means(comparisons = comparisons, method = "wilcox.test") +
#   scale_fill_aaas() +
...
# p4 <- ggplot(df_summary_Strigiformes, aes(x = season, y = record_count, fill = season)) +
#   geom_boxplot() +
#   geom_jitter(width = 0.15, size = 2, alpha = 0.7) + 
#   stat_compare_means(comparisons = comparisons, method = "wilcox.test") +
#   scale_fill_aaas() +
...
# p5 <- ggplot(df_summary_Passeriformes, aes(x = season, y = record_count, fill = season)) +
#   geom_boxplot() +
#   geom_jitter(width = 0.15, size = 2, alpha = 0.7) + 
#   stat_compare_means(comparisons = comparisons, method = "wilcox.test") +
#   scale_fill_aaas() +
...
# p6 <- ggplot(df_summary_Charadriiformes, aes(x = season, y = record_count, fill = season)) +
#   geom_boxplot() +
#   geom_jitter(width = 0.15, size = 2, alpha = 0.7) + 
#   stat_compare_means(comparisons = comparisons, method = "wilcox.test") +
#   scale_fill_aaas() +
